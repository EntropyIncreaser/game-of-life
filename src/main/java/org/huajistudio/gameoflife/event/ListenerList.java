...
public class ListenerList {
	...
	public void register(int id, EnumEventPriority priority, IEventListener listener)
	{
	...
	private class ListenerListInst
	{
		...
		{
			int count = EnumEventPriority.values().length;
		 ...
		 */
		public ArrayList<IEventListener> getListeners(EnumEventPriority priority)
		{
		...
		private void buildCache()
		{
			...
			for (EnumEventPriority value : EnumEventPriority.values())
			{
		...
		public void register(EnumEventPriority priority, IEventListener listener)
		{
